...
class ContributionsControllerTest < ActionController::TestCase
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post :create, contribution: { authtoken: @contribution.authtoken, contributor: @contribution.contributor, qty: @contribution.qty, req: @contribution.req }
    end
  ...
  test "should update contribution" do
    put :update, id: @contribution, contribution: { authtoken: @contribution.authtoken, contributor: @contribution.contributor, qty: @contribution.qty, req: @contribution.req }
    assert_redirected_to contribution_path(assigns(:contribution))
  end
